...
class AIAssistantApp {
    ...
    cacheDOMElements() {
        this.els = {
            ...
            statusWebsim: document.getElementById('status-websim'),
        };
    }
    ...
    async checkServerStatus() {
        try {
            ...
            this.updateStatusDot('websim', statuses.websim || 'error'); // Use the status from server response

        } catch (error) {
            this.updateStatusDot('server', 'error');
            this.updateStatusDot('ollama', 'error');
            this.updateStatusDot('openrouter', 'error');
            this.updateStatusDot('websim', 'error');
        }
    }
